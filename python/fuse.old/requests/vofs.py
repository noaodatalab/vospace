...
class MyIOProxy(IOProxy):
    ...
    def writeToBacking(self):
        ...
        # MJG
        if md5.hexdigest() != vo_md5 and vo_md5 != 'd41d8cd98f00b204e9800998ecf8427e':
            raise OSError(EIO,
...
#                                     cadc_short_cut=True, secure_get=secure_get)
    ...
    #@logExceptions()
#    def no_chmod(self, path, mode): MJG
    ...
    def create(self, path, flags, fi=None):
        ...
        try:
            ...
            node.groupread = parent.groupread
            node.groupwrite = parent.groupwrite
            if node.chmod(flags): # Groupwrite deleted here MJG
    ...
    def getattr(self, path, file_id=None):
        ...
        # MJG - this might be one to check - which attr is being used
