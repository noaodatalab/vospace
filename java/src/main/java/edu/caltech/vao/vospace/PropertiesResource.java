...
public class PropertiesResource extends VOSpaceResource {
    ...
    */
	...
	try {
	    ...
	    String[] props = store.getProperties(manager.PROPERTIES_SPACE_ACCEPTS);
    ...
    public void addProperties(StringBuffer sbuf, String[] list) {
	for (String identifier : list) {
	    sbuf.append("<property uri=\"" + identifier + "\"/>");
	}
    }
