...
public abstract class Node implements Comparable<Object>
{
    ...
    // List of views which this node provides
    protected List<URI> capabilities;
    ...
    /**
     * @return A list of capability uris which the node can use for importing.
     */
    public List<URI> capabilities()
    {
        return capabilities;
    }
    ...
    public void setCapabilities(List<URI> capabilities)
    {
